package Exercício4.Encapsulamento_2;

import Exercício4.Encapsulamento_1.Acesso_Numeros;

public class Verifica_Encapsulamento_2{
    public static void main(String args[]){

        Exercício4.Encapsulamento_1.Acesso_Numeros chave = new Acesso_Numeros();
        
        /*chave.a = 10; ENCAPSULAMENTO
